    ...
    public class UsuarioRoleController : ControllerBase
    {
        ...
        public IActionResult UpdateUsuarioRole([FromBody] UsuarioRoleUpdate usuarioRole)
        {
            try
            {
                if (usuarioRole == null)
                {
                    return BadRequest("UsuarioRoleUpdate object is null");
                }
        ...
        public IActionResult DesactivarUsuario(string correoElectronico)
        {
            try
            {
                _usuarioRoleManager.DesactivarUsuarioRole(correoElectronico);
                return Ok();
            }
            catch (Exception ex)
            {
